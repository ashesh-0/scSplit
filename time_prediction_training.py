...
def get_datasets(opt, tiled_pred=False):
    ...
    assert data_type in ['cifar10', 'Hagen','COSEM_jrc-hela', 'HT_LIF24', "BioSR", "HT_T24"], f'Invalid data type: {data_type}'
    if data_type == 'Hagen':
    ...
    elif data_type in ['cifar10', 'HT_LIF24', 'COSEM_jrc-hela', "BioSR", "HT_T24"]:
